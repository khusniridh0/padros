				...
				<div class="container px-5">
					...
					<div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
						<div class="text-center mb-5">
							...
							<h1 class="fw-bolder">Lupa Kata Sandi</h1>
							<p class="lead fw-normal text-muted mb-0">Atur ulang kata sandi</p>
						</div>
						<div class="row gx-5 justify-content-center">
							<div class="col-lg-8 col-xl-6">
								<form action="<?php echo base_url('auth/forget') ?>" method="post" id="forgetyForm">

									<div class="form-floating mb-3" id="forget-feedback">
										<input class="form-control" name="email" id="forget" type="text" placeholder="Alamat Email" data-sb-validations="required" />
										<label for="forget">Alamat Email</label>
										<div class="invalid-feedback text-danger opacity-75"></div>
									</div>

									<div class="d-grid">
										<button type="submit" class="btn btn-primary btn-lg disabled" id="submitButton">Kirim Kode</button>
									</div>
								</form>
							</div>
						</div>

				...
				<div class="container px-5">
					...
					<div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
						<div class="text-center mb-5">
							...
							<p class="lead fw-normal text-muted mb-0">Masukan Email & Kata sandi</p>
						</div>
						<div class="row gx-5 justify-content-center">
							<div class="col-lg-8 col-xl-6">
								<form action="<?php echo base_url('auth') ?>" method="post" id="loginForm">
									<div class="form-floating mb-3" id="email-feedback">
										<input class="form-control" name="email" id="email" type="text" placeholder="name@example.com" data-sb-validations="required|email" autofocus />
									...
									<div class="form-floating mb-3" id="password-feedback">
										<input class="form-control" name="password" id="password" type="password" placeholder="Masukan kata sandi"/>
									...
									<div class="d-grid">
										<button class="btn btn-primary btn-lg disabled" id="submitButton" type="submit">Masuk</button>
									</div>
								</form>
							</div>
						</div>
